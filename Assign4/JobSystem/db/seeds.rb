...
WorkOrder.create!(details: 'parts mising', status: 'created', worker_id: 4)
WorkOrder.create!(details: 'manager approval', status: 'review', worker_id: 4)
WorkOrder.create!(details: 'back order parts', status: 'in progress', worker_id: 4)
WorkOrder.create!(details: 'insuficicent funds', status: 'completed', worker_id: 4)
