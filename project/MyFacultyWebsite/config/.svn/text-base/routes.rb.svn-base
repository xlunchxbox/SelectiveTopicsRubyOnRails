MyFacultyPages::Application.routes.draw do
  ...
  resources :researches, :only => [ :new, :edit, :create, :update, :destroy ]
  ...
  resources :awards, :only => [ :new, :edit, :create, :update, :destroy ]
